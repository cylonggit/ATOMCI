...
public class AtomicReadFabricWriteEth {
    public AtomicReadFabricWriteEth() throws CertificateException, InvalidKeyException, IOException {
    }



    public void testAtomicReadFabricWriteEth() throws Exception {
        /**
         * Step 1:
        ...
        // ------------ init ---------------------------------------
        initAll(2);
        String labType = "atomic-fabricRead-ethWrite";
