...
public class AtomicReadEth_Writte_Both_dApp1 {
    public AtomicReadEth_Writte_Both_dApp1() throws CertificateException, InvalidKeyException, IOException {
    }

    public void testAtomicReadEth_Writte_both_Aysnc() throws Exception {
        /**
         Step 1:
            Operation 1: re = Function1(Inputs[1]);
         Step 2:
        ...
        // ------------ init ---------------------------------------
        initAll(3);
        String labType = "atomic-ReadEth_write_2";
